...
export default function TestimonialCarousel() {
  ...
  return (
    <div className="block sm:hidden relative overflow-hidden">
      ...
      <button onClick={prevSlide} className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/40 rounded-full p-2">‹</button>
      <button onClick={nextSlide} className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/40 rounded-full p-2">›</button>
    </div>
  );
}