...
// Локальные интерфейсы (остальные импортируются из types/media)
...
export default function MediaPage() {
  ...
  // Debug logging for testimonials (можно убрать после тестирования)
  // useEffect(() => {
  //   console.log('🎯 Текущие данные отзывов в компоненте:', {
  //     testimonialsCount: testimonials.length,
  //     testimonials: testimonials,
  //     currentIndex: currentTestimonialIndex,
  //     currentTestimonial: testimonials[currentTestimonialIndex]
  //   });
  ...
  // Отладочная информация убрана после исправления
              ...
              >
                <div className="relative h-[360px] md:h-[1080px] w-full">
                  <LaravelImage
                    ...
                    fill
                    priority={index < 2} // Only prioritize first 2 process images
                  />
                </div>
